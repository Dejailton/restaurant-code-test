...
class TestDishTable:
    ...
    [
        ...
        ("morning, 1, 2, 3, 3", "eggs, toast, coffee(x2)"),
        ("morning, 1, 2, 3, 3, 3, 3, 3, 3", "eggs, toast, coffee(x6)"),
        ("morning, 1, 3, 2, 3, 3", "eggs, toast, coffee(x3)"),
        ("morning, 3, 1, 3, 2, 3, 3", "eggs, toast, coffee(x4)"),
        ("MORNING  ,  1   ,  2,  3", "eggs, toast, coffee"), 
        ("night, 1, 2, 3, 4", "steak, potato, wine, cake"), 
        ("night, 3, 4, 2, 1", "steak, potato, wine, cake"), 
        ("night, 1, 2, 2, 4", "steak, potato(x2), cake"), 
        ("night, 1, 2, 2, 4, 2", "steak, potato(x3), cake"), 
